      ...
      <div>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="text-white bg-red-500 mb-5 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Tạo mới
            </button>
          </div>
